...
class BlockchainController {
    ...
    getBlockByHeight() {
        this.app.get("/block/:height([0-9]+)", async (req, res) => {
    ...
    // validateChain resolves with the list of errors when validating the chain.
    validateChain() {
        this.app.get("/validate", async (req, res) => {
            ...
            return res.status(200).send("This blockchain is valid!");
        });
    }
